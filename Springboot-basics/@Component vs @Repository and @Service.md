...
Ans: @Component, @Service, and @Repository all technically create the bean (by marking the class for auto-detection and registration in the Spring Context), they are not identical.

We can replace both @Repository and @Service by @Component. But we don't do the reason:

### 1. Why not to replace @Repository to @Component?
...
### 1. Why not to replace @Service to @Component?
